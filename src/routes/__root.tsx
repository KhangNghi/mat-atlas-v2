  ...
  head: () => ({
    meta: [
      ...
      { name: "format-detection", content: "telephone=no" },
      {
        name: "description",
        content:
          "A complete interactive mind map of Brazilian Jiu-Jitsu — positions, guards, passes, sweeps, submissions, and the chains that connect them.",
      },
    ],
    links: [
