...
This is **Mat Atlas v2**, a Brazilian Jiu-Jitsu mind map. Cocktail / Backbar work does not belong here.

## GitHub sync (required after every change)

Repo: [KhangNghi/mat-atlas-v2](https://github.com/KhangNghi/mat-atlas-v2)  
Also: [KhangNghi/mat-atlas](https://github.com/KhangNghi/mat-atlas)  
Remotes: `v2` → `https://github.com/KhangNghi/mat-atlas-v2.git`, `origin` → `https://github.com/KhangNghi/mat-atlas.git`  
Branch: `main`  
...
4. `git push origin main` and `git push v2 main`. Do **not** force-push unless recovering a broken first push they asked for.
5. Do not ask the user to push. Do it yourself.

If `.git` or a remote is missing, re-init and add those remotes, then push `main`.
